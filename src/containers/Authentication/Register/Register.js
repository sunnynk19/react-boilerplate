    ...
    return (
      <div className="row full-height">
        <div className="col-sm-6 text-left left-container-alignment">
          <div className="signin-header">Create account</div>
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group form-check pl-0">
              <label className="form-check-label color-778ca2">
                ...
                <div className="float-right remember-me-class">I agree with terms & conditions</div>
              </label>
            </div>
            <button type="submit" className="btn btn-blue" disabled={!this.validateForm()} >SIGN UP</button>
            ...
            <div className="mt-5">
              <span className = "color-778ca2">Already have an account?</span>
              <Link to="/login" className="color-4d7cfe font-500 cursor-pointer ml-2">Login here</Link>
